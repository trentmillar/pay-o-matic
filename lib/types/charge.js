	...
	Object.defineProperty(this, 'source', {
	    get: function () {
	        if (this.get('source')) {
	            ...
	            this.set('source', this._options[mapping[this.brand].source] || this._options.source);
	            return this.get('source');
	        }
	    }
	...
	this.toRequest = function () {
	    ...
	    switch (this.brand) {
			case 'stripe':
				...
				if(!this.source) req.charge.card = this.cardId;
				if(!this.source) req.charge.customer = this.customerId;
				if(this.source)req.charge.source = this.source;
