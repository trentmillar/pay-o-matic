	...
	Object.defineProperty(this, 'id', {
	    get: function () {
	        if (this.get('id')) {
	            ...
	            this.set('id', options[mapping[this.brand].id] || options.id);
	            return this.get('id');
	        }
	    }
	...
	Object.defineProperty(this, 'cardNumber', {
	    get: function () {
	        if (this.get('cardNumber')) {
	            ...
	            this.set('cardNumber', options[mapping[this.brand].cardNumber] || options.cardNumber);
	            return this.get('cardNumber');
	        }
	    }
	...
	Object.defineProperty(this, 'expiryMonth', {
	    get: function () {
	        if (this.get('expiryMonth')) {
	            ...
	            this.set('expiryMonth', options[mapping[this.brand].expiryMonth] || options.expiryMonth);
	            return this.get('expiryMonth');
	        }
	    }
	...
	Object.defineProperty(this, 'expiryYear', {
	    get: function () {
	        if (this.get('expiryYear')) {
	            ...
	            this.set('expiryYear', options[mapping[this.brand].expiryYear] || options.expiryYear);
	            return this.get('expiryYear');
	        }
	    }
	...
	Object.defineProperty(this, 'cvc', {
	    get: function () {
	        if (this.get('cvc')) {
	            ...
	            this.set('cvc', options[mapping[this.brand].cvc] || options.cvc);
	            return this.get('cvc');
	        }
	    }
	...
	Object.defineProperty(this, 'cardholderName', {
	    get: function () {
	        if (this.get('cardholderName')) {
	            ...
	            this.set('cardholderName', options[mapping[this.brand].cardholderName] || options.cardholderName);
	            return this.get('cardholderName');
	        }
	    }
	...
	Object.defineProperty(this, 'addressLine1', {
	    get: function () {
	        if (this.get('addressLine1')) {
	            ...
	            this.set('addressLine1', options[mapping[this.brand].addressLine1] || options.addressLine1);
	            return this.get('addressLine1');
	        }
	    }
	...
	Object.defineProperty(this, 'addressLine2', {
	    get: function () {
	        if (this.get('addressLine2')) {
	            ...
	            this.set('addressLine2', options[mapping[this.brand].addressLine2] || options.addressLine2);
	            return this.get('addressLine2');
	        }
	    }
	...
	Object.defineProperty(this, 'zipCode', {
	    get: function () {
	        if (this.get('zipCode')) {
	            ...
	            this.set('zipCode', options[mapping[this.brand].zipCode] || options.zipCode);
	            return this.get('zipCode');
	        }
	    }
	...
	Object.defineProperty(this, 'city', {
	    get: function () {
	        if (this.get('city')) {
	            ...
	            this.set('city', options[mapping[this.brand].city] || options.city);
	            return this.get('city');
	        }
	    }
	...
	Object.defineProperty(this, 'state', {
	    get: function () {
	        if (this.get('state')) {
	            ...
	            this.set('state', options[mapping[this.brand].state] || options.state);
	            return this.get('state');
	        }
	    }
	...
	Object.defineProperty(this, 'country', {
	    get: function () {
	        if (this.get('country')) {
	            ...
	            this.set('country', options[mapping[this.brand].country] || options.country);
	            return this.get('country');
	        }
	    }
