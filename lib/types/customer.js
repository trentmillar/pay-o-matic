	...
	Object.defineProperty(this, 'description', {
	    get: function () {
	        if (this.get('description')) {
	            ...
	            this.set('description', options[mapping[this.brand].description] || options.description);
	            return this.get('description');
	        }
	    }
	...
	Object.defineProperty(this, 'email', {
	    get: function () {
	        if (this.get('email')) {
	            ...
	            this.set('email', options[mapping[this.brand].email] || options.email);
	            return this.get('email');
	        }
	    }
	...
	Object.defineProperty(this, 'accountBalance', {
	    get: function () {
	        if (this.get('accountBalance')) {
	            ...
	            this.set('accountBalance', options[mapping[this.brand].accountBalance] || options.accountBalance);
	            return this.get('accountBalance');
	        }
	    }
