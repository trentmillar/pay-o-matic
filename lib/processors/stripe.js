...
Stripe.methods.createCharge_Capture = function (charge, card, customer, cb) {
    ...
    Stripe.methods.createCharge(charge, card, customer, cb);
}
...
Stripe.methods.createChargeByToken = function (charge, cb) {

    if(!charge){
        return cb('charge missing');
    }

    Stripe.methods.createCharge(charge, null, null, cb);
}

Stripe.methods.createCharge = function (charge, card, customer, cb) {
